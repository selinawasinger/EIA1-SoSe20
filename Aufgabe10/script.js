...
function updateCounter() {
    ...
    counterFertigDOMElement.innerHTML = checkmark + " done"; // alle mit todosChecked = true
    counterDOMElement.innerHTML = Tasks.length + " in total";
    counterTodoDOMElement.innerHTML = Tasks.length - checkmark + " open tasks"; //alle mit todosChecked = false
}
/**
